# Avara TypeScript API Library

[![NPM version](<https://img.shields.io/npm/v/avara.svg?label=npm%20(stable)>)](https://npmjs.org/package/avara) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/avara)

This library provides convenient access to the Avara REST API from server-side TypeScript or JavaScript.
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/avara-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install avara`
...
1. Via the `AVARA_LOG` environment variable
...
const client = new Avara({
  logger: logger.child({ name: 'Avara' }),
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/avara-typescript/issues) with questions, bugs, or suggestions.
