...
```sh
npm install git+ssh://git@github.com:avara-software/avara-typescript.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/avara-software/avara-typescript/issues) with questions, bugs, or suggestions.
