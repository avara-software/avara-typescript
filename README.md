...
[![NPM version](<https://img.shields.io/npm/v/avara-software.svg?label=npm%20(stable)>)](https://npmjs.org/package/avara-software) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/avara-software)
...
```ts
import Avara from 'npm:avara-software';
